    ...
    <div class="container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Laporan Permintaan Bulanan</li>
            </ol>
        </nav>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <?php
                    echo form_open('ppic/laporan/excelLapPermintaanBulanan');
                ...
                <?php echo form_close(); ?>
                <?php
                    echo form_open('ppic/laporan/printLapPermintaanBulanan');
                    echo form_hidden('bulan', $bulan);
                    echo form_hidden('tahun', $tahun);
                    ?>
                ...
                <?php echo form_close(); ?>
                <?php
                    echo form_open('ppic/laporan/pdfPermintaanBulanan');
                    echo form_hidden('bulan', $bulan);
                    echo form_hidden('tahun', $tahun);
                    ?>
        ...
        <div class="row mt-3">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Laporan Permintaan Bulanan</h5>
