    ...
    <div class="container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Laporan Penerimaan Bulanan</li>
            </ol>
        </nav>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <?php
                    echo form_open('ppic/laporan/excelLapPenerimaanBulanan');
                ...
                <?php echo form_close(); ?>
                <?php
                    echo form_open('ppic/laporan/printLapPenerimaanBulanan');
                    echo form_hidden('bulan', $bulan);
                    echo form_hidden('tahun', $tahun);
                    ?>
                ...
                <?php echo form_close(); ?>
                <?php
                    echo form_open('ppic/laporan/pdfPenerimaanBulanan');
                    echo form_hidden('bulan', $bulan);
                    echo form_hidden('tahun', $tahun);
                    ?>
        ...
        <div class="row mt-3">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Laporan Penerimaan Bulanan</h5>
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="center">
                                            <?php echo format_indo(date($l->tgl_masuk)) ?>
                                        </td>
                                        <td class="right">
                                            <?= $l->jumlah ?>
                                        </td>
